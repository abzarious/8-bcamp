                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div class="max-w-xl mx-auto bg-white rounded-2xl border border-gray-100 overflow-hidden">
                        <div class="bg-gradient-to-r from-orange-500 to-amber-500 p-6 text-white">
                            <h2 class="text-xl font-bold">Buat Kategori Baru</h2>
                        ...
                        <form action="" method="POST" class="p-6 space-y-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="name" id="name" value="{{ old('name') }}" placeholder="Contoh: Perlengkapan Rumah Tangga"
                            ...
                            <div class="flex items-center justify-end space-x-3 pt-4 border-t border-gray-100">
                                ...
                                <button type="submit" class="px-4 py-2 bg-gradient-to-r from-orange-500 to-amber-500 text-white rounded-xl text-sm font-medium hover:from-orange-600 shadow-sm">Simpan Kategori</button>
                            </div>
                        </form>
                    </div>
